...
export default {
  ...
  data () {
    return {
      ...
      // dataMA5: this.calculateMA(5, this.data),
      // dataMA10: this.calculateMA(10, this.data),
      // dataMA20: this.calculateMA(20, this.data)
      dataA: [
        [20, 30, 10, 35],
        [40, 35, 30, 55],
        [33, 38, 33, 40],
  ...
  methods: {
    ...
    // calculateMA (dayCount) {
    //   let result = []
    //   for (let i = 0, len = this.dataA.length; i < len; i++) {
    //     if (i < dayCount) {
    //       result.push('-')
    //       continue
    //     }
  ...
  mounted () {
    ...
    let option = {
      ...
      xAxis: {
        ...
        //   '2017-10-29', '2017-10-30', '2017-10-31', '2017-11-01', '2017-11-02',
        //   '2017-11-03', '2017-11-04', '2017-11-05', '2017-11-06', '2017-11-07',
        //   '2017-11-08', '2017-11-09', '2017-11-10', '2017-11-11', '2017-11-12',
        //   '2017-11-13', '2017-11-14', '2017-11-15', '2017-11-16', '2017-11-17',
        //   '2017-11-18', '2017-11-19', '2017-11-20', '2017-11-21', '2017-11-22'
        // ],
        scale: true,
        boundaryGap: false,
        axisLine: {onZero: false},
